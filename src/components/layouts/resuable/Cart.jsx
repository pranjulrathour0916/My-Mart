     ...
     <div className=' text-black mt-14 flex flex-row justify-around mx-10  gap-2'>
      ...
      <div className="cart bg-white py-2 ">
       ...
       <div className="price flex items-center gap-3 py-4">
        ...
        <span ><FontAwesomeIcon icon={faIndianRupee}/><span className='text-xl'>442</span></span>
       ...
       <div className='flex gap-10'>
        <div className='flex gap-4'>
          ...
          <span className='border px-6'>1</span>
       ...
       {/* --------------------------------- */}
        <div className='flex border p-2 shadow-sm shadow-black flex-row gap-5 mx-6 mt-3'>
        <div className="image  p-2">
        <img src={headphone} className='w-24 h-20' alt="" />
       </div>
       <div className="desc w-full space-y-1">
       <div className='text-sm font-semibold flex  justify-between'>
         <p className=''>boAt Rockerz 425,25H Battery, BEAST Mode,ENx,Dual</p>
        <p className='text-gray-500'> Delivered by Mon Dec 2</p>
       </div>
        <p className='text-slate-500 text-sm'>Active Black, On the ear</p>
        <p>Seller : BUZZINDIA</p>
       <div className="price flex items-center gap-3 py-4">
        <p className='text-xs line-through'><FontAwesomeIcon icon={faIndianRupee}/> 2499</p>
        <span ><FontAwesomeIcon icon={faIndianRupee}/><span className='text-xl'>999</span></span>
        <span className='text-green-600 text-xs'>66 % Off</span>
       </div>
         <div className='flex gap-10'>
        <div className='flex gap-4'>
          <FontAwesomeIcon className='border p-1 rounded-full' icon={faSubtract}/>
        ...
        <div >
          <ul>
            <li className='flex justify-around'>Price  
              <span> (2 Items)</span>
              <span><FontAwesomeIcon icon={faIndianRupee}/>1441</span>
            </li>
